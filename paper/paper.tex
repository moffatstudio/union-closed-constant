...
\begin{align*}
w\iint\ent(xy)\,d\mu\,d\mu+(1-w)\sum_j\pi_jJ(P_j)\;&\ge\;2wSE_B+2w\sigma E_N\\
&\qquad+\iint_{N\times N}\Big[(1-w)\sqrt{\ent(t_x)\ent(t_y)}-w\Lambda(t_x,t_y)\Big]\,d\mu\,d\mu\;\ge\;2wS\,E,
\end{align*}
the integrand being non-negative by Lemma~\ref{lem:pointwise} (all $t_x,t_y<t_0$) and $\sigma\ge S$.
