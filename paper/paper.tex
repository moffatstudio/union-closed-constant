...
$\Pi_{1,1}(0,0)=1$, $\Pi_{1,y}(0,0)=y$---are derived from those bounds, while $\ent(\Pi)\le1$ holds for every real argument (\texttt{h\_le\_one}, from Mathlib's \texttt{Real.binEntropy\_le\_log\_two})
...
\texttt{UnionClosedCeiling/\allowbreak Refined.lean}, lines 158--164, 287--292, 373--379 and 420--425.
